# -*- coding: utf-8 -*-
# @Time    : 2021/1/14 下午12:46
# @Author  : Luo Lu
# @Email   : argluolu@gmail.com
# @File    : add_noise2img.py
# @Software: PyCharm
...
#
# def cv_test():
#     image = cv2.imread("/home/luolu/PycharmProjects/video-processing/out_frames/00032.jpg")
...
img_src = cv2.imread('/home/luolu/PycharmProjects/video-processing/result_imgs/00544.png')
img_noise = cv2.imread('/home/luolu/PycharmProjects/video-processing/match_images/zt0128.png')
...
# add noise img
noise = cv2.bitwise_not(img_src, img_noise)
# noise = cv2.bitwise_xor(img_src, img_noise)
# PEAK = 0.01
# gauss = np.random.normal(0, 1, img_src.size)
# gauss = gauss.reshape(img_src.shape[0], img_src.shape[1], img_src.shape[2]).astype('uint8')
# noisy = np.random.poisson(gauss / 255.0 * PEAK) / PEAK * 255  # noisy image

cv2.imwrite("/home/luolu/PycharmProjects/video-processing/result_imgs/noise_t.png", noise)
# cv2.imshow('a', noisy.astype('uint8'))
# cv2.waitKey(0)