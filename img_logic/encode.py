...
def main():
	...
	if len(sys.argv) >= 4:
		...
		output_path = '/home/luolu/PycharmProjects/video-processing/result_imgs/encoded_image.png'
...
if __name__ == '__main__':
	# main()
	img_hidden_path = "/home/luolu/PycharmProjects/video-processing/match_images/000d1.jpg"
	img_hidden = Image.open(img_hidden_path)
	# out video path
	pathOut = 'result_imgs/test_t4.avi'

	for img_visible in sorted(glob.glob("/home/luolu/PycharmProjects/video-processing/out_frames/*.jpg")):
		# print(img_visible)
		filename, file_ext = os.path.splitext(img_visible)
		img_visible = Image.open(img_visible)
		print(filename + '.jpg')
		output_path = filename + '.jpg'
		encoded_image = encode(img_visible, img_hidden)
		encoded_image.save(output_path)
